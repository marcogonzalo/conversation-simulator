...
class TestVoiceConversationService:
    """Test cases for VoiceConversationService."""
    ...
    def mock_voice_service(self):
        ...
        service.get_voice_for_accent.return_value = "alloy"
        service.current_provider = "openai"
        return service
...
class TestVoiceConversationServiceIntegration:
    """Integration tests for VoiceConversationService."""
